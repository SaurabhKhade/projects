...
export default function Home() {
  return (
    <div>
      ...
      <Card extra="coming soon..." title="Binary Calculator" img="/img/binary.webp" desc="Get calculators to calculate addition, subtraction, division and multiplication of binary numbers." />
    </div>
  )
}
